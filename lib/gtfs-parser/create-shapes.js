...
module.exports = (function() {
	...
	// ATM this function works synchronously.
	// However, I think this is no big deal is this function is only used before the real server runs.
	var generate = function(city, cb) {
